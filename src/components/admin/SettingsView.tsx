...
const SettingsView: React.FC = () => {
  ...
  // Track active tab
  const [activeTabId, setActiveTabId] = useState("general-settings");
  ...
  return (
    <div className="slds-p-around_medium">
      ...
      <Card className="admin-box">
        ...
        >
          <TabsPanel label="General" id="general-settings">
            <div className="slds-p-around_medium">
          ...
          <TabsPanel label="Videos" id="video-settings">
            <div className="slds-p-around_medium">
              <h2 className="slds-text-heading_medium slds-m-bottom_medium">
                Video Settings
              </h2>
          ...
          <TabsPanel label="Users" id="user-settings">
            <div className="slds-p-around_medium">
              <h2 className="slds-text-heading_medium slds-m-bottom_medium">
                User Settings
              </h2>
          ...
          <TabsPanel label="Analytics" id="analytics-settings">
            <div className="slds-p-around_medium">
              <h2 className="slds-text-heading_medium slds-m-bottom_medium">
                Analytics Settings
              </h2>
          ...
          <TabsPanel label="API" id="api-settings">
            <div className="slds-p-around_medium">
              <h2 className="slds-text-heading_medium slds-m-bottom_medium">
                API Settings
              </h2>
              ...
              <div className="slds-form slds-form_stacked">
                ...
                <div className="slds-form-element slds-m-bottom_large">
                  <label className="slds-form-element__label" htmlFor="api-key">
                    API Key (Read Only)
                  </label>
                  <div className="slds-form-element__control">
                    <Input
